...
| namespaces.<namespace>.certificates | List of each certificate to check and in which cluster namespace these reside. | `- secretName: <secret name on the cluster>
heartBeatUrl: <external HTTP url to ping for heartbeat updates>` |
